...
function hello(){
	...
	var xxx = document.getElementById("hey1").value;
	var zzz = document.getElementById("hey2").value;
	ajax.open('GET', 'http://127.0.0.1:8080/JEETest/login?username=' + xxx + '&password=' + zzz, false);
